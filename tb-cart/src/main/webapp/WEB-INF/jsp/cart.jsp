...
<%
    String staticUrl = "http://static.tb.cn";
...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link href="${staticUrl}/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.tb.cn/"><img clstag="clickcart|keycount|xincart|logo" src="${staticUrl}/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://www.tb.cn/item/${cart.itemId }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.itemImage}" alt="${cart.itemTitle}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="http://www.tb.cn/item/${cart.itemId }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.itemTitle}</a>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://www.tb.cn/order/create.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
...
<script type="text/javascript" src="${staticUrl}/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="${staticUrl}/js/cart.js"></script>
<script type="text/javascript" src="${staticUrl}/js/jquery.price_format.2.0.min.js"></script>
