...
<script type="text/javascript" src="${staticUrl}/js/jquery-extend.js"></script>
<script type="text/javascript" src="${staticUrl}/js/lib-v1.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticUrl}/js/taotao.js" charset="utf-8"></script>
